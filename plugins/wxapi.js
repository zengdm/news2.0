...
wxapi.prototype = {
  ...
  apiUrl: {
    ...
    serieByBrandId: '/products/chexi/peizhi-list-ppid?ppid=',
    // 手机号
    ...
    serieBycxid: '/products/chexi/peizhi-list-cxid',
    seriedetailcxid: '/products/chexi/detail',
   ...
   * 根据cxid获取详情信息
   */
  seriedetailcxid: function(cxid, args, callback) {
      if (cxid) {
          var that = this;
          console.log("333")
          // 拼接参数
          args['cxid'] = cxid;
          that.getURLData('seriedetailcxid', args, callback);
      } else {
          console.log('seriedetailcxid function not find cxid');
      }
  },
    /**
   * 根据cxid获取详情车型
   */
  serieBycxid: function (cxid, args, callback) {
      if (cxid) {
          var that = this;
          console.log("2222222222")
          // 拼接参数
          args['cxid'] = cxid;
          that.getURLData('serieBycxid', args, callback);
      } else {
          console.log('serieBycxid function not find cxid');
      }
  },
  /**
   * 根据pinyin
