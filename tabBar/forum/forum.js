...
Page({
  ...
  sheTwo: function (e) {
    ...
    that.data.loginInfo = that.userApi.wxlogin();


    // wx.getSetting({
    //   success: function (res) {
    //     if (res.authSetting['scope.userInfo']) {
    //       that.data.loginInfo = true;
    //     }
    //   }
    // })
  ...
  onShow: function () {
    ...
    var apps = getApp();
    // console.log('waimian =====' + defaultNav.path);
    // console.log(apps.defaultNav.path);
    if (defaultNav.path != apps.defaultNav.path) {
      // console.log('123');
      // console.log(defaultNav.path);
      // console.log(apps.defaultNav.path);
  ...
  photoClick: function (e) {
    ...
    var bannerimg = e.currentTarget.dataset.ext_info
    that.data.v_url = e.currentTarget.dataset.v_url
      if (bannerimg) {
      ...
      wx.navigateTo({
        url: '/pages/web/web?v_url=' + that.data.v_url
      })
    }
  },
